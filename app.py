    ...
    "wwjd": {
        ...
        "locks": [
            ...
            },
            {
                "id": "s1",
                "name": "Spell1",
                "prompt": "What if the key is too large to fit into the lock? Great things sometimes must become small.",
                "input_type": "spell",
                "spell": "reducio",
                "unlock_message": "Spell accepted.",
                "clue": "It is like Voldemort implanted something in my head. Can you hear it too? PG99",
                "clue_linked_id": "tunes",
            },
            {
                "id": "tunes",
                "name": "Tunes",
                ...
                "note_sequence": ["C", "C", "D", "D", "D", "D", "D", "D", "C", "D", "C", "A"],
            },
            {
                "id": "s2",
                "name": "Spell 2",
                ...
                "input_type": "spell",
                "clue": "Check out the note he left under his cymbal. Maybe this can lead us closer to finding him.",
                "clue_linked_id": "abandon",
                "spell": "accio",
                "unlock_message": "Spell accepted.",
            },
            {
            ...
            },
            {
                "id": "s3",
                "name": "Spell 3",
                "prompt": "Strength and magic remain, but one thing must leave its master's hand.",
                "input_type": "spell",
                "spell": "expelliarmus",
                "clue": "Jesse has always been a great dancer, he just needed a partner that could match his style. Maybe that can help you figure out the right pose.",
                "clue_linked_id": "strike",
                "unlock_message": "Spell accepted.",
            },
            {
                "id": "strike",
                "name": "Strike",
                "prompt": "It takes two to tango. But in this case you need to HOLD the right pose.",
                "image_url": "/static/images/PoseXX.png",
                "input_type": "pose",
                "pose_name": "x pose",
            ...
            },
            {
                ...
                "input_type": "spell",
                "clue": "It looks like he left a note on the fridge, but it got covered up by something.",
                "spell": "avada kedavra",
                "unlock_message": "Spell accepted.",
            },
            {
                "id": "found",
                "name": "Found",
                "prompt": "What did he buy?",
                "hint_after_failures": 2,
                "hint_text": "What are the short-form of what Jesse bought at the store?",
                "code": "TP",
                "input_length": 2,
            },
        ],
